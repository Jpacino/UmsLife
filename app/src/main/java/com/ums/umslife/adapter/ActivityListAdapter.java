...
public class ActivityListAdapter extends BaseAdapter {
	...
	private List<ActivityBean.DataBean.AllActivityListBean> activityLists;
	private Context mContext;

	public ActivityListAdapter(List<ActivityBean.DataBean.AllActivityListBean> activityLists,
			Context mContext) {
		super();
