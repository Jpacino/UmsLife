...
public class ActivityBean implements Serializable {
	...
	public static class DataBean implements Serializable{
		...
		private List<PersonActivityListBean> personActivityList;
		...
		public List<PersonActivityListBean> getPersonActivityList() {
			return personActivityList;
		}

		public void setPersonActivityList(List<PersonActivityListBean> personActivityList) {
			this.personActivityList = personActivityList;
		}
		...
		public static class PersonActivityListBean implements Serializable{
			/**
			 * activityContent : 一起看樱花吧。
			 * activityNo : 3
			 * activityPlace : 请查看活动详情的相关地点。
